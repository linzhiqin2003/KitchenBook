          ...
          <form @submit.prevent="handleRegister">
            ...
            <div class="form-field">
              ...
              <div class="input-wrapper">
                ...
                <input class="input has-icon" type="password" v-model="password" required minlength="6" placeholder="至少 6 位" />
              </div>
            </div>
            <div class="form-field">
              <label>确认密码</label>
              <div class="input-wrapper">
                <Lock :size="16" class="input-icon" />
                <input class="input has-icon" type="password" v-model="password2" required placeholder="再次输入密码" />
              </div>
            </div>
...
import { BookOpenText, Mail, Lock, Loader2, ScanLine, Users, BarChart3, User as UserIcon } from "lucide-vue-next";
