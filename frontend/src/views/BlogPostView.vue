      ...
      <div class="container mx-auto px-4 md:px-6">
        <div class="flex items-center justify-between h-16 md:h-20">
          ...
          <router-link to="/blog" class="flex items-center gap-3 group">
            ...
            <div>
              <h1 :class="['text-lg font-bold transition-colors', isDarkTheme ? 'text-white group-hover:text-violet-300' : 'text-slate-800 group-hover:text-slate-600']">LZQ's Tech Blog</h1>
          ...
          <nav class="flex items-center gap-2 md:gap-6">
            <router-link 
              to="/blog" 
              :class="['flex items-center gap-2 text-sm transition-colors px-3 py-2 rounded-lg', isDarkTheme ? 'text-slate-400 hover:text-white hover:bg-white/5' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100']"
            >
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          ...
          <div class="flex items-center gap-4">
            <a 
              href="https://github.com/linzhiqin2003" 
              target="_blank"
              :class="['flex items-center gap-2 transition-colors', isDarkTheme ? 'text-slate-500 hover:text-violet-400' : 'text-slate-500 hover:text-slate-800']"
            >
