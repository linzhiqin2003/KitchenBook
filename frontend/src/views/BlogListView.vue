                ...
                <button
                  ...
                  :class="[
                    ...
                    isDarkTheme
                      ...
                      : 'bg-white/50 hover:bg-white/80 border border-slate-200/60 hover:border-slate-300 shadow-sm hover:shadow-md'
                  ]"
                >
                  <div class="w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-1"
                    :style="{ background: isDarkTheme ? `linear-gradient(135deg, ${cat.color}15, ${cat.color}30)` : 'rgba(0,0,0,0.04)' }">
                    <svg v-if="cat.slug === 'web-server-architecture'" class="w-8 h-8" :class="isDarkTheme ? '' : 'text-slate-700'" :style="isDarkTheme ? { color: cat.color } : {}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                    </svg>
                    <svg v-else class="w-8 h-8" :class="isDarkTheme ? '' : 'text-slate-700'" :style="isDarkTheme ? { color: cat.color } : {}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
